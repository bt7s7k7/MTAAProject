...
`,
      ...
      ;(t.stemmer = (function () {
        ...
        var n = { icate: 'ic', ative: '', alize: 'al', iciti: 'ic', ical: 'ic', ful: '', ness: '' }
        var r = '[^aeiou]'
        var i = '[aeiouy]'
        var s = r + '[^aeiouy]*'
        var o = i + '[aeiou]*'
        ...
        var w = /.$/
        var k = /(at|bl|iz)$/
        var _ = new RegExp('([^aeiouylsz])\\1$')
        var B = new RegExp('^' + s + i + '[^aeiouwxy]$')
        var A = /^(.+?[^aeiou])y$/
        var j =
          /^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/
        var $ = /^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/
        var V =
          /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/
        var q = /^(.+?)(s|t)(ion)$/
        var C = /^(.+?)e$/
        var z = /ll$/
        var W = new RegExp('^' + s + i + '[^aeiouwxy]$')
        var N = function (c) {
          var v
          var P
          var T
            ...
            for (
              ...
              for (var d = s[u], y = 0; y < l; y++) {
                ...
                if (p == d || d == '*') {
                  ...
                  var g = r.qNode.edges[d]
                  var L = b.final && g.final
                  var f = void 0
                  p in r.output.edges
      ...
      ;(t.Index = function (e) {
        ...
        (t.Index.prototype.query = function (e) {
          ...
          for (var l = 0; l < n.clauses.length; l++) {
            ...
            for (var b of d) {
              ...
              var L = this.tokenSet.intersect(g).toArray()
          ...
          for (var l = 0; l < c.length; l++) {
            ...
            if (N.contains(h) && !R.contains(h)) {
              ...
              var O = i[T.fieldName].similarity(x)
              var M
        ...
        (t.Index.load = function (e) {
          ...
          var l = t.Pipeline.load(e.pipeline)
          e.version != t.version &&
            t.utils.warn(
      ...
      ;(t.Builder = function () {
        ...
        (t.Builder.prototype.add = function (e, n) {
          ...
          for (var s = 0; s < i.length; s++) {
            ...
            var l = a ? a(e) : e[o]
            var u = this.tokenizer(l, { fields: [o] })
            var d = this.pipeline.run(u)
            var y = new t.FieldRef(r, o)
            var p = Object.create(null)
        ...
        (t.Builder.prototype.createFieldVectors = function () {
          for (
            ...
            for (
              ...
              var f = y[L]
              var m = d[f]
              var S = this.invertedIndex[f]._index
              var w
              var k
              var _
              i[f] === void 0
        ...
        (t.MatchData.prototype.combine = function (e) {
          for (var n = Object.keys(e.metadata), r = 0; r < n.length; r++) {
            ...
            for (var a of s) {
              var l = Object.keys(e.metadata[i][a])
  ...
  async function le(t, e) {
    ...
    let r = new Blob([await n.arrayBuffer()]).stream().pipeThrough(new DecompressionStream('gzip'))
    let i = await new Response(r).json()
    ;(t.data = i),
  ...
  function he() {
    ...
    let n = document.getElementById('tsd-search-script')
    ...
    let i = document.querySelector('#tsd-search .results')
  ...
  function Ve(t, e, n, r) {
    ...
    for (let a of s) {
      let l = r.data.rows[Number(a.ref)]
      let u = 1
    ...
    for (let o = 0, a = Math.min(10, s.length); o < a; o++) {
      ...
      let u = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon"><use href="#icon-${l.kind}"></use></svg>`
      let d = ce(l.name, i)
  ...
  var Be = !1
  var D = !1
  var me = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
    navigator.userAgent
  )
...
`),
  ...
  async function xe() {
    ...
    let r = new Blob([n]).stream().pipeThrough(new DecompressionStream('gzip'))
    let i = await new Response(r).json()
  ...
  function we(t, e, n) {
    ...
    if (t.children) {
      let i = [...n, t.text]
      let s = r.appendChild(document.createElement('details'))
